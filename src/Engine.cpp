...
//Internal loop that actually runs the engine
void Engine::Run()
{
	//Preloads
	...
	{
		//Actual engine loop. Update objects, clear then render them.
...
{
	strcpy_s(info.title, 128, "Base Window");
